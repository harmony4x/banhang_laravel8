            ...
            <section class="">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" method="POST" action="{{route('product_price.update',$product->id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Giá nhập sản phẩm" disabled value="{{$cost}}" name="cost">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="quantity" placeholder="Số lượng sản phẩm..." disabled value="0" name="quantity">
                            </div>
